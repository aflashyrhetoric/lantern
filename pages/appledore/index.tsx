...
const Appledore: React.FC = (props: any) => {
  ...
  return (
    <Page>
      <Auth0Provider
        domain="lantern-go.us.auth0.com"
        clientId="lnRb0HqUtdHjZmb7Zxx5ZmdlZvOvSrkD"
        redirectUri={"http://localhost:3000/appledore"}
      >
        <div>
          <Modal
            danger
          ...
          <LTable
            ...
            rawRowData={people && people.length > 0 ? people : []}
            rowData={
